          ...
          <div
            ...
            <div className="relative overflow-hidden aspect-video">
              ...
              <div className="absolute inset-0 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <a href={certif.link} className="p-3 rounded-full glass hover:bg-primary hover:text-primary-foreground transition-all">
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-start justify-between">
                <h3 className="text-xl font-semmibold group-hover:text-primary transition-colors">{certif.title}</h3>
                <ArrowUpRight className="w-5 h-5 
